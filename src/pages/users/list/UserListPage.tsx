            ...
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-8">
                <div>
                    <h1 className="text-2xl font-bold text-[var(--primary)] flex items-center gap-3">
                        <span className="p-2.5 rounded-xl bg-gradient-to-br from-[var(--main)] to-indigo-600 text-white shadow-lg shadow-[var(--main)]/20">
                    ...
                    <p className="text-[var(--primary)]/50 mt-1.5 ml-12 font-medium">Foydalanuvchilarni boshqarish markazi</p>
                </div>

                <button
                    onClick={() => navigate('/all-users/create-user')}
                    className="flex items-center gap-2 bg-[var(--main)] hover:bg-[var(--main)]/90 text-white px-6 py-3 rounded-xl font-bold transition-all shadow-xl shadow-[var(--main)]/30 hover:-translate-y-1 active:translate-y-0"
                >
