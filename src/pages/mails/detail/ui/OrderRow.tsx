...
import { formatPrice, formatDate, getStatusStyle, getStatusLabel } from "../lib/helpers";
...
const OrderRow = memo(({ order, checked, onToggle }: OrderRowProps) => (
    ...
    >
        ...
        <button
            ...
            className="flex items-center justify-center w-7 h-7 rounded-lg bg-gray-100 dark:bg-white/8 text-black dark:text-white/60 hover:bg-main/10 hover:text-main dark:hover:bg-main/20 dark:hover:text-white transition-all duration-200 shrink-0 cursor-pointer"
        >
            <Printer size={13} />
        </button>
    </div>
