        ...
        <div
          ...
          className={`flex items-center gap-3 p-4 rounded-2xl w-full cursor-pointer transition-all duration-200 border
            ${activeTab === "markets"
              ...
              : "bg-white dark:bg-background text-gray-600 dark:text-gray-300 border-gray-200 dark:border-white/10 hover:border-main/30 hover:bg-gray-50 dark:hover:bg-background/80"
            }`}
        >
          <Store size={20} />
