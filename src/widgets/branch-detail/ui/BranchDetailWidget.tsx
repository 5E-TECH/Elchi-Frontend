  ...
  return (
    <>
      <div className="space-y-5">
          <div className="relative overflow-hidden rounded-[1.5rem] border border-[color:var(--color-border-soft)] bg-[var(--color-card-surface-strong)] p-5 shadow-[0_18px_42px_rgba(39,44,82,0.1)] dark:border-white/10 dark:bg-[var(--color-surface-elevated-dark)] sm:p-6">
          ...
          <div className="rounded-[1.5rem] border border-[color:var(--color-border-soft)] bg-[var(--color-card-surface-strong)] p-3 shadow-[0_14px_34px_rgba(39,44,82,0.08)] dark:border-white/10 dark:bg-[var(--color-surface-elevated-dark)] sm:p-4">
            ...
            <div className="mt-4 rounded-[1.25rem] border border-[color:var(--color-border-soft)] bg-[var(--color-card-surface-strong)] p-4 dark:border-white/10 dark:bg-[var(--color-surface-elevated-dark)] sm:p-5">
