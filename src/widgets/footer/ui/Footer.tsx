...
const Footer = () => {
    return (
        <footer className="w-full bg-sidebar backdrop-blur-md border-t dark:bg-maindark border-main py-6 px-8 text-center text-sm text-maindark transition-colors duration-300">
