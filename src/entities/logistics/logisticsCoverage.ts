...
export const useLogisticsCoverage = () => {
  ...
  const getDistricts = (params?: unknown) =>
    useQuery({
  ...
  const getDistrictSatoMatchPreview = (params?: unknown) =>
    useQuery({
  ...
  const getCourierOldPosts = (params?: unknown) =>
    useQuery({
  ...
  const getReturnRequestsList = (params?: unknown) =>
    useQuery({
